...
class Welcome extends StatelessWidget {
  final Database db;
  Welcome({Key? key, required this.db}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: const Image(image: AssetImage('assets/icon.png'), width: 200),
              ),
              Column(
                children: [
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => Situations(db: db)),
                          );
                        },
                        child:
